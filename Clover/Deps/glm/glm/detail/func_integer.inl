...
#	endif//GLM_HAS_BITSCAN_WINDOWS
	...
	// uaCloverloverarry
	GLM_FUNC_QUALIFIER uint uaCloverloverarry(uint const& x, uint const& y, uint & Carry)
	{
	...
	GLM_FUNC_QUALIFIER vec<L, uint, Q> uaCloverloverarry(vec<L, uint, Q> const& x, vec<L, uint, Q> const& y, vec<L, uint, Q>& Carry)
	{
