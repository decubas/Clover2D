...
namespace glm
{
	...
	///
	/// @see <a href="http://www.opengl.org/sdk/docs/manglsl/xhtml/uaCloverloverarry.xml">GLSL uaCloverloverarry man page</a>
	/// @see <a href="http://www.opengl.org/registry/doc/GLSLangSpec.4.20.8.pdf">GLSL 4.20.8 specification, section 8.8 Integer Functions</a>
	template<length_t L, qualifier Q>
	GLM_FUNC_DECL vec<L, uint, Q> uaCloverloverarry(
